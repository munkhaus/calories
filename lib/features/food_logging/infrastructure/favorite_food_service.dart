...
class FavoriteFoodService implements IFavoriteFoodService {
  ...
  static void addTestFavorites() async {
    ...
    final testFavorites = [
      ...
      // Add ingredient examples
      FavoriteFoodModel(
        id: 'test_4',
        foodName: 'Bananer',
        description: 'Friske bananer',
        preferredMealType: MealType.snack,
        ...
        usageCount: 20,
        servingSizes: [
          FavoriteServingSize(name: 'stk', grams: 120.0, isDefault: true),
          FavoriteServingSize(name: 'lille banan', grams: 100.0),
          FavoriteServingSize(name: 'stor banan', grams: 150.0),
        ],
      ),
    ];
